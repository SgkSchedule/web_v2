        ...
        <div class="p-6">
          <div class="flex items-start mb-3">
            <div class="flex items-center h-5">
              <input id="darkMode" type="checkbox" v-model="settings.darkMode" @change="settingsChanged()" class="w-4 h-4 bg-gray-50 rounded border border-gray-300 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" required>
            </div>
          ...
          <div class="flex items-start mb-4">
            <div class="flex items-center h-5">
              <input id="abbreviation" type="checkbox" v-model="settings.abbreviation" @change="settingsChanged()" class="w-4 h-4 bg-gray-50 rounded border border-gray-300 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" required>
            </div>
